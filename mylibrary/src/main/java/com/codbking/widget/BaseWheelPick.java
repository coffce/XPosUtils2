 ...
 */
 abstract class BaseWheelPick
    ...
    protected int textColor = 0x4DFFFFFF;
    protected int selectColor = 0xffffffff;
    ...
    public BaseWheelPick(Context context, AttributeSet attrs) {
        ...
        textColor = a.getColor(R.styleable.DatePicker_picker_text_color, 0x4DFFFFFF);
        selectColor = a.getColor(R.styleable.DatePicker_picker_select_textColor, 0xffffffff);
        split = a.getColor(R.styleable.DatePicker_picker_split, 0xffdddddd);
        splitHeight = (int) a.getDimension(R.styleable.DatePicker_picker_split_height, 0.8f);
